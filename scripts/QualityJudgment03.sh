#!/bin/bash
# 黄埔高位停车服务器：通过 testmvp 抓图并打包，供 sync_task_03.py 下载处理
...
LOG_FILE="./quality_execution_03.log"
...
log_msg "Running QualityJudgment03 for project: ${PROJECT_NAME}, MVP_IP: ${MVP_IP}"
