...
PULL_LOG_FILE = os.path.join(LOG_DIR, "sync_task_04_pull.log")


REMOTE_SH = os.path.join(SCRIPT_DIR, "QualityJudgment04.sh")
PROJECT_NAME="浦东高位停车"
SCRIPT_PATH = "scripts/sync_task_04.py"
...
def create_directories(client):
    ...
    # 只清理 tmp 工作目录（QualityJudgment04.sh 内部也会清理 tmp，这里做兜底）
    print("      清理远端 tmp ...")
